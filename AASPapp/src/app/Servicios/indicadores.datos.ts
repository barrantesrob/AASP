export class Indicadores {
    public static Datos: any = [
        ...
        {
            'LimiteInferior': 'Decil 10 y CI(95%)',
            'Decil' : 10,
            'Items': [
                            {
                                'NombreIndicador': 'Proporción de asignaturas aprobadas',
